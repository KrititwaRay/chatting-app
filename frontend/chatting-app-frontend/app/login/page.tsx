...
const LoginPage = () => {
    ...
    try {
        ...
        alert(data.response.status.message);
            ...
            <div className='max-w-md w-full'>
                <div className='bg-gray-800 border border-gray-700 rounded-lg p-8' >
                    ...
                    <form onSubmit={handleSubmit} className='space-y-6'>
                        <div>
                            <label htmlFor="email" className='text-sm font-medium text-gray-300 mb-2'>Email Address</label>
                            <input type="email" id='email' className='w-full px-4 py-4 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400' placeholder='Enter your email address' value={email} required 
