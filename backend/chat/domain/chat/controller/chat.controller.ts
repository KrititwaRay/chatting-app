...
export class ChatController {
    ...
    getMessagesByChat = async (req: Request, res: Response) => {
        try {
            ...
            let response_data = await this._chatService.getMessagesByChat(loginUser, req.params.chatId as string, token);
